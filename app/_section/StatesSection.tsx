...
export default function StatesSection({ state, update }: Props) {
  return <SectionCard title="State Preview" subtitle="State Preview controls for native stepper generation.">
...
<Slider label="Error step (0 is none)" value={state.errorStep} min={0} max={14} step={1} onChange={(value) => update("errorStep", value)} /></div>
    </SectionCard>;
}
