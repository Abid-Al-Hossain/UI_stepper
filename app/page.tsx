...
export default function Page() {
  const [state, setState] = useState<StepperState>(DEFAULT_STEPPER_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Stepper Studio" controls={controls} preview={output} /></AppShell>;
}
